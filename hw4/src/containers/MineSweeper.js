...
const MineSweeper = () => {
    ...
    return (
        <div className='mineSweeper'>
            ...
            <HomePage startGameOnClick={startGameOnClick} mineNumOnChange={mineNumOnChange} boardSizeOnChange={boardSizeOnChange}  mineNum={mineNum} boardSize={boardSize} startGame={startGame}/>
            <Board startGame={startGame} boardSize={boardSize} mineNum={mineNum} backToHome={backToHomeOnClick}/>
